...
public class ListAvailableStaff : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //{            
        //    if (transform != null && transform.gameObject != null && transform.gameObject != staffContainer && transform.gameObject.GetComponent<StaffHandler>().isAssignedToProject == false)
        //    {
